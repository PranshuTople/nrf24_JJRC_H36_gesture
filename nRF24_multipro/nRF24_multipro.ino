 ...
 ******************************************************************************
 ...
 This is a fork of the nrf24_JJRC_H36_pc project
 from Lewis Cornik on Github https://github.com/githubLewis/nrf24_JJRC_H36_pc
 which was itself a fork of the Multi-Protocol nRF24L01 Tx project
 ...
 drone via code running on a PC using Hand Tracking. 
 This code was originally made by
 Lewis Cornick on 22 April 2018
 githubLewis on github.com

 Made few minor changes to suit with new Arduino Update
 
 If you have any doubts or queries DM and
 Follow on Instagram for constat project updates
 https://instagram.com/pranshutople 

 Pranshu Tople 01 September 2019
 PranshuTople on github.com
